    ...
    _makeRequest(hash) {
        ...
        const promise = new AJAXPromise((resolve, reject) => {
            jqXHR
                ...
                const response = this.handleResponse(jqXHR.status, parseResponseHeaders(jqXHR.getAllResponseHeaders()), payload, requestData);
                ...
                if (textStatus === 'timeout') {
                    ...
                    response = this.handleResponse(jqXHR.status, parseResponseHeaders(jqXHR.getAllResponseHeaders()), payload, requestData);
                }
                const rejectionParam = {
                    payload,
                    textStatus,
